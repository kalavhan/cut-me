...
import barber2 from '../../images/barber3.png';
  ...
  render () {
    ...
    return (
      <div className={styles.homeSlider}>
        <img id="imageBarber1" className={`${barber0c} ${styles.sliderImage}`} src={barber0} alt="barber at cut me" />
        <img id="imageBarber2" className={`${barber1c} ${styles.sliderImage}`} src={barber1} alt="barber at cut me" />
        <img id="imageBarber3" className={`${barber2c} ${styles.sliderImage}`} src={barber2} alt="barber at cut me" />
